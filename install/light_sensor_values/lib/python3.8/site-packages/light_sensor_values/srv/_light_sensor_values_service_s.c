...
bool light_sensor_values__srv__light_sensor_values_service__request__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("light_sensor_values.srv._light_sensor_values_service.LightSensorValuesService_Request", full_classname_dest, 85) == 0);
  }
  light_sensor_values__srv__LightSensorValuesService_Request * ros_message = _ros_message;
  {  // a
...
{
  /* NOTE(esteve): Call constructor of LightSensorValuesService_Request */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("light_sensor_values.srv._light_sensor_values_service");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "LightSensorValuesService_Request");
...
ROSIDL_GENERATOR_C_EXPORT
bool light_sensor_values__srv__light_sensor_values_service__response__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("light_sensor_values.srv._light_sensor_values_service.LightSensorValuesService_Response", full_classname_dest, 86) == 0);
  }
  light_sensor_values__srv__LightSensorValuesService_Response * ros_message = _ros_message;
  {  // sum
...
{
  /* NOTE(esteve): Call constructor of LightSensorValuesService_Response */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("light_sensor_values.srv._light_sensor_values_service");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "LightSensorValuesService_Response");
    assert(pymessage_class);
    Py_DECREF(pymessage_module);
    _pymessage = PyObject_CallObject(pymessage_class, NULL);
    Py_DECREF(pymessage_class);
