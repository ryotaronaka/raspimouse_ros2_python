...
class Metaclass_MotorFreqs(type):
    """Metaclass of message 'MotorFreqs'."""
    ...
    def __import_type_support__(cls):
        try:
            ...
            logger = logging.getLogger(
                'raspimouse_msgs.msg.MotorFreqs')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
            cls._CREATE_ROS_MESSAGE = module.create_ros_message_msg__msg__motor_freqs
            cls._CONVERT_FROM_PY = module.convert_from_py_msg__msg__motor_freqs
            cls._CONVERT_TO_PY = module.convert_to_py_msg__msg__motor_freqs
            cls._TYPE_SUPPORT = module.type_support_msg__msg__motor_freqs
            cls._DESTROY_ROS_MESSAGE = module.destroy_ros_message_msg__msg__motor_freqs
...
class MotorFreqs(metaclass=Metaclass_MotorFreqs):
    """Message class 'MotorFreqs'."""
