...
class Move_Goal(metaclass=Metaclass_Move_Goal):
    ...
    def __init__(self, **kwargs):
        ...
        self.move = array.array('f', kwargs.get('move', []))
    ...
    def move(self, value):
        if isinstance(value, array.array):
            assert value.typecode == 'f', \
                "The 'move' array.array() must have the type code of 'f'"
            self._move = value
            return
        if __debug__:
            ...
            assert \
                ((isinstance(value, Sequence) or
                 ...
                 True), \
                "The 'move' field must be a set or sequence and each value of type 'float'"
        self._move = array.array('f', value)
...
class Metaclass_Move_SendGoal_Request(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            from raspimouse_msgs.action import Move
...
class Move_SendGoal_Request(metaclass=Metaclass_Move_SendGoal_Request):
    ...
    _fields_and_field_types = {
        ...
        'goal': 'raspimouse_msgs/Move_Goal',
    }

    SLOT_TYPES = (
        rosidl_parser.definition.NamespacedType(['unique_identifier_msgs', 'msg'], 'UUID'),  # noqa: E501
        rosidl_parser.definition.NamespacedType(['raspimouse_msgs', 'action'], 'Move_Goal'),  # noqa: E501
    )
    ...
    def __init__(self, **kwargs):
        ...
        from raspimouse_msgs.action._move import Move_Goal
...
class Metaclass_Move_SendGoal(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'raspimouse_msgs.action.Move_SendGoal')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
            ...
            from raspimouse_msgs.action import _move
...
class Move_SendGoal(metaclass=Metaclass_Move_SendGoal):
    from raspimouse_msgs.action._move import Move_SendGoal_Request as Request
    from raspimouse_msgs.action._move import Move_SendGoal_Response as Response
...
class Move_GetResult_Response(metaclass=Metaclass_Move_GetResult_Response):
    ...
    _fields_and_field_types = {
        'status': 'int8',
        'result': 'raspimouse_msgs/Move_Result',
    }

    SLOT_TYPES = (
        rosidl_parser.definition.BasicType('int8'),  # noqa: E501
        rosidl_parser.definition.NamespacedType(['raspimouse_msgs', 'action'], 'Move_Result'),  # noqa: E501
    )
    ...
    def __init__(self, **kwargs):
        ...
        from raspimouse_msgs.action._move import Move_Result
...
class Metaclass_Move_GetResult(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'raspimouse_msgs.action.Move_GetResult')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
...
class Move_GetResult(metaclass=Metaclass_Move_GetResult):
    from raspimouse_msgs.action._move import Move_GetResult_Request as Request
    from raspimouse_msgs.action._move import Move_GetResult_Response as Response
...
class Metaclass_Move_FeedbackMessage(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'raspimouse_msgs.action.Move_FeedbackMessage')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
...
class Move_FeedbackMessage(metaclass=Metaclass_Move_FeedbackMessage):
    ...
    _fields_and_field_types = {
        'goal_id': 'unique_identifier_msgs/UUID',
        'feedback': 'raspimouse_msgs/Move_Feedback',
    }

    SLOT_TYPES = (
        rosidl_parser.definition.NamespacedType(['unique_identifier_msgs', 'msg'], 'UUID'),  # noqa: E501
        rosidl_parser.definition.NamespacedType(['raspimouse_msgs', 'action'], 'Move_Feedback'),  # noqa: E501
    )
    ...
    def __init__(self, **kwargs):
        ...
        from unique_identifier_msgs.msg import UUID
        self.goal_id = kwargs.get('goal_id', UUID())
        from raspimouse_msgs.action._move import Move_Feedback
...
class Move(metaclass=Metaclass_Move):
    ...
    from raspimouse_msgs.action._move import Move_Goal as Goal
    # The result message defined in the action definition.
    from raspimouse_msgs.action._move import Move_Result as Result
    # The feedback message defined in the action definition.
    from raspimouse_msgs.action._move import Move_Feedback as Feedback

    class Impl:

        # The send_goal service using a wrapped version of the goal message as a request.
        from raspimouse_msgs.action._move import Move_SendGoal as SendGoalService
        # The get_result service using a wrapped version of the result message as a response.
        from raspimouse_msgs.action._move import Move_GetResult as GetResultService
        # The feedback message with generic fields which wraps the feedback message.
        from raspimouse_msgs.action._move import Move_FeedbackMessage as FeedbackMessage
