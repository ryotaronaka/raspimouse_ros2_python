...
class MoveRobot_SendGoal_Request(metaclass=Metaclass_MoveRobot_SendGoal_Request):
    ...
    _fields_and_field_types = {
        ...
        'goal': 'raspimouse_msgs/MoveRobot_Goal',
    }

    SLOT_TYPES = (
        rosidl_parser.definition.NamespacedType(['unique_identifier_msgs', 'msg'], 'UUID'),  # noqa: E501
        rosidl_parser.definition.NamespacedType(['raspimouse_msgs', 'action'], 'MoveRobot_Goal'),  # noqa: E501
    )
    ...
    def __init__(self, **kwargs):
        ...
        from raspimouse_msgs.action._move_robot import MoveRobot_Goal
...
class Metaclass_MoveRobot_SendGoal(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'raspimouse_msgs.action.MoveRobot_SendGoal')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
            ...
            from raspimouse_msgs.action import _move_robot
...
class MoveRobot_SendGoal(metaclass=Metaclass_MoveRobot_SendGoal):
    from raspimouse_msgs.action._move_robot import MoveRobot_SendGoal_Request as Request
    from raspimouse_msgs.action._move_robot import MoveRobot_SendGoal_Response as Response
...
class MoveRobot_GetResult_Response(metaclass=Metaclass_MoveRobot_GetResult_Response):
    ...
    _fields_and_field_types = {
        'status': 'int8',
        'result': 'raspimouse_msgs/MoveRobot_Result',
    }

    SLOT_TYPES = (
        rosidl_parser.definition.BasicType('int8'),  # noqa: E501
        rosidl_parser.definition.NamespacedType(['raspimouse_msgs', 'action'], 'MoveRobot_Result'),  # noqa: E501
    )
    ...
    def __init__(self, **kwargs):
        ...
        from raspimouse_msgs.action._move_robot import MoveRobot_Result
...
class Metaclass_MoveRobot_GetResult(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'raspimouse_msgs.action.MoveRobot_GetResult')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
...
class MoveRobot_GetResult(metaclass=Metaclass_MoveRobot_GetResult):
    from raspimouse_msgs.action._move_robot import MoveRobot_GetResult_Request as Request
    from raspimouse_msgs.action._move_robot import MoveRobot_GetResult_Response as Response
...
class Metaclass_MoveRobot_FeedbackMessage(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'raspimouse_msgs.action.MoveRobot_FeedbackMessage')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
...
class MoveRobot_FeedbackMessage(metaclass=Metaclass_MoveRobot_FeedbackMessage):
    ...
    _fields_and_field_types = {
        'goal_id': 'unique_identifier_msgs/UUID',
        'feedback': 'raspimouse_msgs/MoveRobot_Feedback',
    }

    SLOT_TYPES = (
        rosidl_parser.definition.NamespacedType(['unique_identifier_msgs', 'msg'], 'UUID'),  # noqa: E501
        rosidl_parser.definition.NamespacedType(['raspimouse_msgs', 'action'], 'MoveRobot_Feedback'),  # noqa: E501
    )
    ...
    def __init__(self, **kwargs):
        ...
        from unique_identifier_msgs.msg import UUID
        self.goal_id = kwargs.get('goal_id', UUID())
        from raspimouse_msgs.action._move_robot import MoveRobot_Feedback
...
class Metaclass_MoveRobot(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'raspimouse_msgs.action.MoveRobot')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
...
class MoveRobot(metaclass=Metaclass_MoveRobot):
    ...
    from raspimouse_msgs.action._move_robot import MoveRobot_Goal as Goal
    # The result message defined in the action definition.
    from raspimouse_msgs.action._move_robot import MoveRobot_Result as Result
    # The feedback message defined in the action definition.
    from raspimouse_msgs.action._move_robot import MoveRobot_Feedback as Feedback

    class Impl:

        # The send_goal service using a wrapped version of the goal message as a request.
        from raspimouse_msgs.action._move_robot import MoveRobot_SendGoal as SendGoalService
        # The get_result service using a wrapped version of the result message as a response.
        from raspimouse_msgs.action._move_robot import MoveRobot_GetResult as GetResultService
        # The feedback message with generic fields which wraps the feedback message.
        from raspimouse_msgs.action._move_robot import MoveRobot_FeedbackMessage as FeedbackMessage
