...
bool light_sensor_values__msg__light_sensor_values__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("light_sensor_values.msg._light_sensor_values.LightSensorValues", full_classname_dest, 62) == 0);
  }
  light_sensor_values__msg__LightSensorValues * ros_message = _ros_message;
  {  // right_forward
...
{
  /* NOTE(esteve): Call constructor of LightSensorValues */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("light_sensor_values.msg._light_sensor_values");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "LightSensorValues");
