...
class Metaclass_LightSensorValues(type):
    """Metaclass of message 'LightSensorValues'."""
    ...
    def __import_type_support__(cls):
        try:
            ...
            logger = logging.getLogger(
                'light_sensor_values.msg.LightSensorValues')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
            cls._CREATE_ROS_MESSAGE = module.create_ros_message_msg__msg__light_sensor_values
            cls._CONVERT_FROM_PY = module.convert_from_py_msg__msg__light_sensor_values
            cls._CONVERT_TO_PY = module.convert_to_py_msg__msg__light_sensor_values
            cls._TYPE_SUPPORT = module.type_support_msg__msg__light_sensor_values
            cls._DESTROY_ROS_MESSAGE = module.destroy_ros_message_msg__msg__light_sensor_values
...
class LightSensorValues(metaclass=Metaclass_LightSensorValues):
    """Message class 'LightSensorValues'."""
    ...
    def __init__(self, **kwargs):
        ...
        self.sum_all = kwargs.get('sum_all', int())
        self.sum_forward = kwargs.get('sum_forward', int())
    ...
    def __eq__(self, other):
        ...
        if self.left_forward != other.left_forward:
            return False
        if self.sum_all != other.sum_all:
            return False
        if self.sum_forward != other.sum_forward:
            return False
        return True
    ...
    def sum_all(self, value):
        if __debug__:
            assert \
                isinstance(value, int), \
                "The 'sum_all' field must be of type 'int'"
            assert value >= -32768 and value < 32768, \
                "The 'sum_all' field must be an integer in [-32768, 32767]"
        self._sum_all = value

    @property
    def sum_forward(self):
        """Message field 'sum_forward'."""
        return self._sum_forward

    @sum_forward.setter
    def sum_forward(self, value):
        if __debug__:
            assert \
                isinstance(value, int), \
                "The 'sum_forward' field must be of type 'int'"
            assert value >= -32768 and value < 32768, \
                "The 'sum_forward' field must be an integer in [-32768, 32767]"
        self._sum_forward = value
