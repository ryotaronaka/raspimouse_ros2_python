...
static const _LightSensorValues_type_support_symbol_names_t _LightSensorValues_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, light_sensor_values, msg, LightSensorValues)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, light_sensor_values, msg, LightSensorValues)),
  }
};
...
{
  return &::light_sensor_values::msg::rosidl_typesupport_cpp::LightSensorValues_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, light_sensor_values, msg, LightSensorValues)() {
  return get_message_type_support_handle<light_sensor_values::msg::LightSensorValues>();
}
