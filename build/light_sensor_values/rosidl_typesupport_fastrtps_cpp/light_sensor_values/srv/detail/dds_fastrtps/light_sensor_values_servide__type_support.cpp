...
#include "light_sensor_values/srv/detail/light_sensor_values_servide__rosidl_typesupport_fastrtps_cpp.hpp"
...
{
  auto typed_message =
    static_cast<const light_sensor_values::srv::LightSensorValuesServide_Request *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<light_sensor_values::srv::LightSensorValuesServide_Request *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _LightSensorValuesServide_Request__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const light_sensor_values::srv::LightSensorValuesServide_Request *>(
...
{
  return max_serialized_size_LightSensorValuesServide_Request(full_bounded, 0);
}

static message_type_support_callbacks_t _LightSensorValuesServide_Request__callbacks = {
...
static rosidl_message_type_support_t _LightSensorValuesServide_Request__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_LightSensorValuesServide_Request__callbacks,
...
{
  return &light_sensor_values::srv::typesupport_fastrtps_cpp::_LightSensorValuesServide_Request__handle;
}
...
{
  auto typed_message =
    static_cast<const light_sensor_values::srv::LightSensorValuesServide_Response *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<light_sensor_values::srv::LightSensorValuesServide_Response *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _LightSensorValuesServide_Response__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const light_sensor_values::srv::LightSensorValuesServide_Response *>(
...
{
  return max_serialized_size_LightSensorValuesServide_Response(full_bounded, 0);
}

static message_type_support_callbacks_t _LightSensorValuesServide_Response__callbacks = {
  "light_sensor_values::srv",
...
static rosidl_message_type_support_t _LightSensorValuesServide_Response__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_LightSensorValuesServide_Response__callbacks,
  get_message_typesupport_handle_function,
};
...
{
  return &light_sensor_values::srv::typesupport_fastrtps_cpp::_LightSensorValuesServide_Response__handle;
}
...
static service_type_support_callbacks_t _LightSensorValuesServide__callbacks = {
  "light_sensor_values::srv",
...
static rosidl_service_type_support_t _LightSensorValuesServide__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_LightSensorValuesServide__callbacks,
...
{
  return &light_sensor_values::srv::typesupport_fastrtps_cpp::_LightSensorValuesServide__handle;
}
