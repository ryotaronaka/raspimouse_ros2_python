...
#ifndef RASPIMOUSE_MSGS__SRV__DETAIL__MOTOR_FREQS_SERVICE__FUNCTIONS_H_
#define RASPIMOUSE_MSGS__SRV__DETAIL__MOTOR_FREQS_SERVICE__FUNCTIONS_H_
...
/// Initialize srv/MotorFreqsService message.
/**
...
/// Finalize srv/MotorFreqsService message.
/**
...
/// Create srv/MotorFreqsService message.
/**
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * raspimouse_msgs__srv__MotorFreqsService_Request__init().
...
/// Destroy srv/MotorFreqsService message.
/**
 * It calls
 * raspimouse_msgs__srv__MotorFreqsService_Request__fini()
...
/// Initialize array of srv/MotorFreqsService messages.
/**
...
/// Finalize array of srv/MotorFreqsService messages.
/**
 * It calls
 * raspimouse_msgs__srv__MotorFreqsService_Request__fini()
...
/// Create array of srv/MotorFreqsService messages.
/**
 * It allocates the memory for the array and calls
 * raspimouse_msgs__srv__MotorFreqsService_Request__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/// Destroy array of srv/MotorFreqsService messages.
/**
 * It calls
 * raspimouse_msgs__srv__MotorFreqsService_Request__Sequence__fini()
 * on the array,
 ...
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * raspimouse_msgs__srv__MotorFreqsService_Response__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_raspimouse_msgs
...
/**
 * It calls
 * raspimouse_msgs__srv__MotorFreqsService_Response__fini()
 * and frees the memory of the message.
 * \param[in,out] msg The allocated message pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_raspimouse_msgs
...
/**
 * It allocates the memory for the array and calls
 * raspimouse_msgs__srv__MotorFreqsService_Response__Sequence__init().
 * \param[in] size The size / capacity of the array.
 * \return The pointer to the initialized array if successful, otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_raspimouse_msgs
...
/**
 * It calls
 * raspimouse_msgs__srv__MotorFreqsService_Response__Sequence__fini()
 * on the array,
 * and frees the memory of the array.
 * \param[in,out] array The initialized array pointer.
 */
...
#endif  // RASPIMOUSE_MSGS__SRV__DETAIL__MOTOR_FREQS_SERVICE__FUNCTIONS_H_
