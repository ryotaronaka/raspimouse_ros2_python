...
class Init_MotorFreqsService_Response_sum
{
public:
  Init_MotorFreqsService_Response_sum()
  : msg_(::rosidl_runtime_cpp::MessageInitialization::SKIP)
  {}
  ::raspimouse_msgs::srv::MotorFreqsService_Response sum(::raspimouse_msgs::srv::MotorFreqsService_Response::_sum_type arg)
  {
...
private:
  ::raspimouse_msgs::srv::MotorFreqsService_Response msg_;
};
...
{
  return raspimouse_msgs::srv::builder::Init_MotorFreqsService_Response_sum();
}
